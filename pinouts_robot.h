...
// sparkfun TB6612FNG (PaperBot) motorshield and L298N (MiniRosco) Motor Driver
...
const int AIN1 = 2; // Direction    **** guess A0 = D18
const int AIN2 = 4; // Direction    **** guess A1 = D19
...
#define SERVO_PIN_TILT    9  // Arduino pin tied to tilt servo pin.
